...
import { AlbumGroupEnum, albumGroupEnumSchema } from './albumGroupEnum';
import {
...
export const artistDiscographyAlbumObjectSchema: Schema<ArtistDiscographyAlbumObject> = object(
  {
    ...
    albumGroup: ['album_group', albumGroupEnumSchema],
  }
);
