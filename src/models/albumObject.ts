...
} from './pagingSimplifiedTrackObject';
import {
...
export const albumObjectSchema: Schema<AlbumObject> = object({
  ...
  tracks: ['tracks', lazy(() => pagingSimplifiedTrackObjectSchema)],
  copyrights: ['copyrights', array(lazy(() => copyrightObjectSchema))],
  externalIds: ['external_ids', lazy(() => externalIdObjectSchema)],
