...
export const segmentObjectSchema: Schema<SegmentObject> = object({
  start: ['start', optional(number())],
  duration: ['duration', optional(number())],
  confidence: ['confidence', optional(number())],
  loudnessStart: ['loudness_start', optional(number())],
  loudnessMax: ['loudness_max', optional(number())],
  loudnessMaxTime: ['loudness_max_time', optional(number())],
  loudnessEnd: ['loudness_end', optional(number())],
  pitches: ['pitches', optional(array(number()))],
  timbre: ['timbre', optional(array(number()))],
});
