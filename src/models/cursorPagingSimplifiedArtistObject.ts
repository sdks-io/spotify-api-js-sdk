...
export const cursorPagingSimplifiedArtistObjectSchema: Schema<CursorPagingSimplifiedArtistObject> = object(
  {
    ...
    items: ['items', optional(array(lazy(() => artistObjectSchema)))],
  }
);
